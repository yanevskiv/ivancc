...
static const Err_Entry Err_Table[ERR_CODE_COUNT] = {
    ...
    [ERR_PP_EXPR_VALUE_MISSING]         = { "ERR_PP_EXPR_VALUE_MISSING",         "expected a value in preprocessor expression" },
    [ERR_PP_EXPR_TOKEN_INVALID]         = { "ERR_PP_EXPR_TOKEN_INVALID",         "token \"%.*s\" is not valid in preprocessor expressions" },
    [ERR_PP_EXPR_OPERATOR_MISSING]      = { "ERR_PP_EXPR_OPERATOR_MISSING",      "missing binary operator before token \"%.*s\"" },
    [ERR_PP_EXPR_PAREN_MISSING]         = { "ERR_PP_EXPR_PAREN_MISSING",         "missing ')' in expression" },
    [ERR_PP_EXPR_COLON_MISSING]         = { "ERR_PP_EXPR_COLON_MISSING",         "'?' without following ':'" },
    [ERR_PP_EXPR_DIVISION_BY_ZERO]      = { "ERR_PP_EXPR_DIVISION_BY_ZERO",      "division by zero in #if" },
