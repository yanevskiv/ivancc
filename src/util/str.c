...
// Decode a quoted-string body into raw bytes.
...
// Test whether pattern matches anywhere in str.
...
// Match pattern against str, filling groups with owned capture text.
